...
export function HomeCtaSection() {
  return (
    <ScrollReveal>
      <section className="relative overflow-hidden rounded-[2.25rem] border border-white/10 shadow-[0_20px_70px_rgba(10,28,52,0.18)]">
        <img
        ...
        />
        <Card className="rounded-[2.25rem] border-0 bg-transparent shadow-none">
          <Card.Content className="relative flex min-h-[320px] flex-col items-start justify-between gap-6 p-8 sm:flex-row sm:items-center sm:p-12 lg:p-16">
            <div>
