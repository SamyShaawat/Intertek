...
export function MetricCard({ value, label }: { value: string; label: string }) {
  return (
    <Card className="group rounded-[1.75rem] border border-white/75 bg-white/90 shadow-[0_16px_50px_rgba(10,28,52,0.08)] backdrop-blur-xl transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_24px_60px_rgba(10,28,52,0.12)]">
